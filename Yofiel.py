...
\033[0;36m =============YOFIEL CREATED THIS DDOS======================"""
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;[-] YofielTools | Api Connected [5] | Backup Server [1] | Online User [1000] | Admin: [Yofiel] | POWER : {}% [UNSTABLE]\x07".format (powerran))
		...
		if sinput == "cls":
			...
			try:
				...
				if running >= 1000:
					...
					print("\033[91m[-] Yofiel Generation Attack.")
					...
					print("\033[97m[/] Yofiel Generation Attack....")
